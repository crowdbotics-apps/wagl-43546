"""
Django settings for wagl_43546 project.
...
WSGI_APPLICATION = 'wagl_43546.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wagl_43546 API",
    "DESCRIPTION": "API documentation for wagl_43546 App",
    "VERSION": "v1",
}
